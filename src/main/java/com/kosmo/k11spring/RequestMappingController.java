...
public class RequestMappingController {
	...
	/*
	 	...
	 	전송방식까지 명시해야하는 경우에는 속성을 제거하면 에러가 발생된다.
	 */
	...
	public String getSearch(HttpServletRequest req, Model model) {
		...
		String sColumn = req.getParameter("searchColumn"); // index.jsp의 name1
		String sWord = req.getParameter("searchWord"); // index.jsp의 name2
	...
	/*
	 @ModelAttribute 어노테이션
	 	: 뷰로 전달되는 커맨드 객체의 이름을 임의로 변경하고 싶을때 사용한다.
	 	아래 코드는 studentDTO -> si로 이름을 변경한 후 View로 데이터를 전달한다.
	 */
	@RequestMapping("/requestMapping/modeAttribute")
